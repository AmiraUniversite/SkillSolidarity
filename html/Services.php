...
<body>
    <div class="container">
        ...
        <ul class="options">
            ...
            <button class="button" onclick="afficherAnnonces('Jardinage')">Jardinage</button>
            <button class="button" onclick="afficherAnnonces('Plomberie')">Plomberie</button>
            <button class="button" onclick="afficherAnnonces('Aide à domicile')">Aide à domicile</button>
            <button class="button" onclick="afficherAnnonces('Peinture')">Peinture</button>
            <button class="button" onclick="afficherAnnonces('Mécanique')">Mécanique</button>
            <button class="button" onclick="afficherAnnonces('Déménagement')">Déménagement</button>
            <li><a href="#" class="button">Autres</a></li>
             ...
             <script>
                function afficherAnnonces(categorie) {
                    ...
                    xmlhttp.open("GET", "annonces.php?categorie=" + categorie, true);
                    xmlhttp.send();
                }
            </script>
