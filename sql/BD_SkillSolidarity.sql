...
ALTER TABLE public."Service" DROP CONSTRAINT IF EXISTS "Service_nomservice_check";
ALTER TABLE public."Service" ADD CONSTRAINT "Service_nomservice_check" CHECK (NomService ~ '^[A-Za-z ]+$');
...
-- Table Posséder
CREATE TABLE IF NOT EXISTS public."Posséder" (
    IDUtilisateur VARCHAR(50),
...
-- Table Nécéssiter
CREATE TABLE IF NOT EXISTS public."Nécéssiter" (
    IDService VARCHAR(50),
    IDCompetence VARCHAR(50),
...
INSERT INTO public."Utilisateur" (IDUtilisateur, NomU, PrénomU, EmailU, MotDePasseU, Adresse, Code_Postal, Ville, DateInscriptionU, NoteU, CreditU, RoleU) VALUES
...
INSERT INTO public."Competence" (IDCompetence, NomCompetence, Niveau_Debutant_Intermédiaire_Expert_, _CatégorieCompetence_) VALUES
...
INSERT INTO public."Service" (IDService, NomService, Description_optionnel_, Categorie, CategorieSecondaire, DateService, DependenceMeteo, CreditRequis, CompétenceRequise) VALUES
...
INSERT INTO public."Avis" (IDAvis, Note, Commentaire, DateAvis, IDUtilisateur, IDService) VALUES
...
INSERT INTO public."Offrir" (IDService, IDUtilisateur, DateService) VALUES
('S1', 'U1', '2023-05-15 09:00:00'),
('S2', 'U2', '2023-05-20 10:00:00');

-- Insertion de données dans la table Planifier
INSERT INTO public."Planifier" (IDService, IDUtilisateur, DateService) VALUES
('S3', 'U3', '2023-06-01 09:00:00');

-- Insertion de données dans la table Posséder
INSERT INTO public."Posséder" (IDUtilisateur, IDCompetence) VALUES
('U1', 'C1'),
('U2', 'C2'),
('U3', 'C3');

-- Insertion de données dans la table Nécéssiter
INSERT INTO public."Nécéssiter" (IDService, IDCompetence) VALUES
('S1', 'C1'),
('S2', 'C2'),
('S3', 'C3');

-- Insertion de données dans la table Demander
INSERT INTO public."Demander" (IDService, IDUtilisateur, DateService) VALUES
